...
4つのソースからAEDデータを収集・統合:

| ソース | 件数 | 内容 |
|--------|------|------|
| 川崎市オープンデータ | 535件 | 公共施設のAED |
| 全国AEDマップ(qqzaidanmap) | 649件 | 登録型AEDマップ |
| aedm.jp | 2,225件 | 投稿型AEDマップ（細密グリッド取得） |
| セブン-イレブン | 90件 | コンビニAED |

**統合後: 3,499件**（重複除去済み、座標あり）
...
- **全国AEDマップ(登録型)**: https://www.qqzaidanmap.jp/
- **aedm.jp(投稿型)**: https://aedm.jp/
- **e-Stat（政府統計）**: https://www.e-stat.go.jp/

## 📅 データ時点

- AEDデータ: 2026年1月時点（qqzaidanmap + aedm.jp統合）
- 人口データ: 川崎市将来人口推計（R7〜R52）
