...
- 東京消防庁「令和5年 救急活動の現況」に基づく年齢別リスク重み
- リスク加重人口での評価

出典: 東京消防庁「令和5年 救急活動の現況」
      図表3-4, 3-5 人口1万人あたりの性別・年齢層別心停止傷病者搬送人員
      https://www.tfd.metro.tokyo.lg.jp/learning/elib/kyukyukatudojittai/r5.html
"""
...
# 東京消防庁「令和5年 救急活動の現況」に基づく
# 発生率は人口1万人あたりの心停止傷病者搬送人員（男女平均）
AGE_RISK_WEIGHTS = {
    '0〜4歳': 0.71,    # 発生率 1.75
    '5〜9歳': 0.16,    # 発生率 0.40
    '10〜14歳': 0.18,  # 発生率 0.45
    '15〜19歳': 0.51,  # 発生率 1.25
    '20〜24歳': 0.76,  # 発生率 1.85
    '25〜29歳': 0.43,  # 発生率 1.05
    '30〜34歳': 0.69,  # 発生率 1.70
    '35〜39歳': 0.57,  # 発生率 1.40
    '40〜44歳': 1.00,  # 発生率 2.45（基準）
    '45〜49歳': 1.12,  # 発生率 2.75
    '50〜54歳': 2.33,  # 発生率 5.70
    '55〜59歳': 2.59,  # 発生率 6.35
    '60〜64歳': 4.00,  # 発生率 9.80
    '65〜69歳': 4.35,  # 発生率 10.65
    '70〜74歳': 6.73,  # 発生率 16.50
    '75〜79歳': 11.63, # 発生率 28.50
    '80〜84歳': 19.45, # 発生率 47.65
    '85〜89歳': 30.78, # 発生率 75.40
    '90〜94歳': 50.02, # 発生率 122.55
    '95歳以上': 72.24  # 発生率 177.00
}
